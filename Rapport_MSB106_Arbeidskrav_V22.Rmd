...
hld_arb <- read_csv("Data/hld_arb.csv")
sun_arb <- read_csv("Data/sun_arb.csv")
har_arb <- read_csv("Data/har_arb.csv")
syssel_bos <- read_csv("Data/syssel_bos.csv")
hld_bos <- read_csv("Data/hld_bos.csv")
sun_bos <- read_csv("Data/sun_bos.csv")
har_bos <- read_csv("Data/har_bos.csv")
```
...
hld_arb %>% 
  ...
  geom_line() +
  labs(title = "Haugalandet", y= "Alle Næringer") + 
...
sun_arb %>% 
  ggplot(mapping = aes(x = År, y = Totalt)) +
  geom_line() +
  labs(title = "Sunnhordland", y= "Alle Næringer") + 
  scale_x_continuous(breaks = seq(2008, 2020, by = 1))
```
