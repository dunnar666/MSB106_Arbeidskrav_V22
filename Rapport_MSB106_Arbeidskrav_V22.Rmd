...
# Ola: Skal vi ta vekk denne, Kevin? - Sjå dei to kode-chunkane under, og vurder
...
```{r Næringsfordeling_og_Utvikling_Haugelandet_3_Største}
hld_arb_long %>% 
  # Vi ønsker å studere alle kommunene som formelt sett regnes som Haugalandet
...
```{r Næringsfordeling_og_Utvikling_Haugelandet_4_Minste}
hld_arb_long %>% 
  # Vi ønsker å studere alle kommunene som formelt sett regnes som Haugalandet
  ...
  # Lager et panel som viser flere grafer, fordelt på 4 kolonner
...
```{r Næringsfordeling_og_Utvikling_Sunnhordland_3_Største}
sun_arb_long %>% 
  # Vi ønsker å studere alle kommunene som formelt sett regnes som Sunnhordland
...
```{r Næringsfordeling_og_Utvikling_Sunnhordland_4_Minste}
sun_arb_long %>% 
  # Vi ønsker å studere alle kommunene som formelt sett regnes som Sunnhordland
...
```{r Næringsfordeling_og_Utvikling_Hardanger}
har_arb_long %>% 
  # Vi ønsker å studere alle kommunene som formelt sett regnes som Hardanger
