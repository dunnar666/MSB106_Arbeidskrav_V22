...
```{r}
hld_arb <- hld_arb %>% 
  filter(NACE2007 %in% c("00-99", "01-03", "10-33", "35-39", "41-43", "64-66", "85", "86-88")) %>% select(-NAstatus)
```

```{r}
hld_arb <- hld_arb[-c(105, 106, 107, 108), ]
hld_arb[is.na(hld_arb)] = 0
```
...
hld_arb <- hld_arb %>% 
  mutate(
    NACE2007 = fct_recode(NACE2007,
                       ...
                       "Industri" = "10-33",
                       "Elektrisitet, Vann og Renovasjon" = "35-39",
                       "Bygge- og Annleggsvirksomhet" = "41-43",
                       "Finansiering og Forsikring" = "64-66",
                       "Undervisning" = "85",
...
```{r}
sun_arb <- sun_arb %>% 
  filter(NACE2007 %in% c("00-99", "01-03", "10-33", "35-39", "41-43", "64-66", "85", "86-88"))
```
