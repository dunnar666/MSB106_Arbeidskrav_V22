...
```{r}
hld_bos <- hld_bos %>% 
  filter(NACE2007 %in% c("00-99", "10-33", "01-03", "85", "86-88")) # KOPIER
```
  ...
  mutate(
    NACE2007 = fct_recode(NACE2007,
                     "Alle Næringer" = "00-99",
                       ...
                       "Industri" = "10-33",
                       "Undervisning" = "85",
                       "Helse- og Sosialtjenester" = "86-88")) # KOPIER
```
...
```{r}
sun_bos <- sun_bos %>% 
  filter(NACE2007 %in% c("00-99", "10-33", "01-03", "85", "86-88")) # Sett inn
```
...
sun_bos <- sun_bos %>% 
  mutate(
    NACE2007 = fct_recode(NACE2007,
                          ...
                          "Industri" = "10-33",
                          "Undervisning" = "85",
                          "Helse- og Sosialtjenester" = "86-88")) # Sett inn
```
